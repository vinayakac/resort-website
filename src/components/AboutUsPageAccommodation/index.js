...
function AboutUsPageAccommodation() {
    return (
        <div className="about-us-page-accommodation-container">
            <div className="about-page-rooms-content-container">
                <div className="home-page-rooms-content-header">ACCOMDATION</div>
...
export default AboutUsPageAccommodation